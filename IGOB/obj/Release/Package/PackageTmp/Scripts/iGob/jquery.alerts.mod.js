...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch(type) {
				case 'warning':
					var IDPOP = 'popup_title_Warning';
				break;
				case 'error':
					var IDPOP = 'popup_title_Error';
				break;
				default:
					var IDPOP = 'popup_title';
				break;
			}
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('\
						<div id="popup_panel">\
							<input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="btn btn-success" />\
						</div>\
					');
				...
				case 'confirm':
					$("#popup_message").after('\
						<div id="popup_panel">\
							<input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="btn btn-success"/>\
							<input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" class="btn btn-primary" />\
						</div>\
					');
					$("#popup_ok").click( function() {
						$.alerts._hide();
			...
			if( $.alerts.draggable ) {
				try {
					$("#popup_container").draggable({ handle: $("#"+IDPOP) });
					$("#"+IDPOP).css({ cursor: 'move' });

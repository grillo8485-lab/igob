...
function ImprimirDictamen() {
    ...
    $.ajax({
        data: parametros,
        url: '/LicitacionesDictamen/ImprimirSolicitud/',
        type: 'post',
        beforeSend: function () {
...
function saveGenerarPublicarPropuestaTecnicaEconomica() {
    ...
    $.ajax({
        data: parametros,
        url: '/LicitacionesDictamen/saveGenerarPublicarPropuestaTecnicaEconomica/',
        type: 'post',
        beforeSend: function () {
        ...
        success: function (response) {
            console.log(response);
            if (response.success) {
                mensaje("Aviso", "El dictamen se ha generado", "/LicitacionesDictamen/Index/?pIdLic=" + IdLic);
            }
            else {

...
{
    public class beAdjudicacionesLiquidez {

        public int IdAdjudicacionLiquidez { get; set; }
	...
	public beAdjudicacionesLiquidez()
	{
		
	}

	public beAdjudicacionesLiquidez( int pIdAdjudicacionLiquidez, int pIdAdjudicacion, int pIdEstatus, int pIdOrigenRecurso, int pIdCuentaBancaria, string pNumeroOperacion, decimal pSaldoCuenta, decimal pSaldoIgob, decimal pMontoComprometido, DateTime pFechaDeposito, int pIdUsuarioRegistro, DateTime pFechaRegistro,
        string pNumeroCuenta, string pNombreCuenta, decimal pMontoDisponible, string pOrigenRecurso, string pNombreCorto
        )
	{
		this.IdAdjudicacionLiquidez = pIdAdjudicacionLiquidez;
